    ...
    <div className="max-w-2xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Fund your account to start creating campaigns
        </p>
      </div>
          ...
          return (
            ...
            >
              <CardContent className="p-4 flex items-center gap-4">
                <div
                  className={`w-10 h-10 rounded-xl bg-muted/50 flex items-center justify-center text-primary`}
                >
      ...
      <div className="p-6 rounded-2xl bg-amber-500/10 border border-amber-500/20">
        ...
        <p className="text-xs text-amber-500/80 leading-relaxed">
          Razorpay deposits are verified automatically and credited immediately
          after successful payment. Other payment methods are processed
          manually, and balances are updated once an administrator reviews the
          transaction details.
        </p>
      </div>
    </div>
