...
const TABS = [
  {
    ...
    label: "General",
    icon: Globe,
    desc: "Core site details and behavior",
  },
  {
    id: "email",
    label: "Email & SMTP",
  ...
  },
  {
    ...
    label: "Social Login",
    icon: Users,
    desc: "Google and Facebook OAuth",
  },
  {
    id: "payouts",
    label: "Payouts",
    icon: Wallet,
    desc: "Withdraw limits and timers",
  },
  {
    id: "methods",
  ...
  },
  {
    ...
    icon: Megaphone,
    desc: "Banner and popup configs",
  },
  {
    id: "captcha",
    label: "Security & CAPTCHA",
    icon: ShieldCheck,
    desc: "reCAPTCHA configuration",
  },
  {
    id: "advanced",
    label: "Advanced",
    icon: Code,
    desc: "Custom CSS and JS injection",
  },
];
...
function SaveBtn({ keys, saving, onSave }: SaveBtnProps) {
  return (
    <Button
      onClick={() => onSave(keys)}
      disabled={saving}
              ...
              <div
                className={cn(
                  ...
                  activeTab === t.id
                    ...
                    : "bg-card border border-border/50 group-hover:border-border"
                )}
              >
                ...
                {activeTab === "general" && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        value={vals.site_description ?? ""}
                        onChange={(e) =>
                          set("site_description", e.target.value)
                        }
                        className="bg-muted/50 focus:bg-background resize-none min-h-[100px]"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-6 pt-4 border-t border-border/30">
                      <div className="space-y-2">
                        ...
                        <Input
                          type="number"
                          value={vals.alias_min_length ?? "5"}
                          onChange={(e) =>
                            set("alias_min_length", e.target.value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          type="number"
                          value={vals.alias_max_length ?? "7"}
                          onChange={(e) =>
                            set("alias_max_length", e.target.value)
                          }
                          className="bg-muted/50"
                        />
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        value={vals.disallowed_domains ?? ""}
                        onChange={(e) =>
                          set("disallowed_domains", e.target.value)
                        }
                    ...
                    <div className="space-y-2 pt-4 border-t border-border/30">
                      ...
                      <Input
                        type="number"
                        value={vals.referral_percentage ?? "20"}
                        onChange={(e) =>
                          set("referral_percentage", e.target.value)
                        }
                        className="bg-muted/50 max-w-[200px]"
                      />
                      <p className="text-xs text-muted-foreground">
                        Percentage of earnings paid to the referrer (lifetime).
                      </p>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-destructive/20 bg-destructive/5 mt-4">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">
                          Redirect all short links directly without ads while
                          enabled.
                        </p>
                      </div>
                      <Switch
                        checked={vals.maintenance_mode === "1"}
                ...
                {activeTab === "email" && (
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Select
                        value={vals.mail_driver ?? "smtp"}
                        onValueChange={(v) => set("mail_driver", v || "smtp")}
                      >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-border/30">
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <Select
                          value={vals.smtp_encryption ?? "tls"}
                          onValueChange={(v) =>
                            set("smtp_encryption", v || "tls")
                          }
                        >
                          <SelectTrigger className="bg-muted/50 max-w-[300px]">
                            <SelectValue />
                    ...
                    <div className="p-5 rounded-xl border border-border/50 bg-card/40 space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            value={vals.google_client_id ?? ""}
                            onChange={(e) =>
                              set("google_client_id", e.target.value)
                            }
                            className="bg-muted/50"
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              set("google_client_secret", e.target.value)
                            }
                            className="bg-muted/50"
                          />
                        </div>
                    ...
                    <div className="p-5 rounded-xl border border-border/50 bg-card/40 space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label>App ID</Label>
                          <Input
                            value={vals.facebook_app_id ?? ""}
                            onChange={(e) =>
                              set("facebook_app_id", e.target.value)
                            }
                            className="bg-muted/50"
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <Input
                            type="password"
                            value={vals.facebook_app_secret ?? ""}
                            onChange={(e) =>
                              set("facebook_app_secret", e.target.value)
                            }
                            className="bg-muted/50"
                          />
                        </div>
                ...
                {activeTab === "methods" && (
                  <div className="space-y-6">
                    <p className="text-sm text-muted-foreground mb-6">
                      Select which payment methods users can choose to withdraw
                      their earnings.
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {[
                        ...
                        <label
                          key={method}
                          className="flex items-start gap-3 p-4 bg-muted/20 hover:bg-muted/40 rounded-xl border border-border/50 cursor-pointer transition-colors"
                        >
                          <Switch
                            checked={vals[`withdraw_method_${method}`] === "1"}
                            onCheckedChange={(c) =>
                              set(`withdraw_method_${method}`, c ? "1" : "0")
                            }
                          />
                          <div className="space-y-1">
                            ...
                            <p className="text-xs text-muted-foreground leading-tight">
                              Enable transfers via {method.replace("_", " ")}
                            </p>
                          </div>
                        </label>
                      ))}
                    ...
                    <div className="pt-6 flex justify-end">
                      <SaveBtn
                        keys={[
                          ...
                          "withdraw_method_bank_transfer",
                          "withdraw_method_payeer",
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          value={vals.member_default_advert ?? "1"}
                          onValueChange={(v) =>
                            set("member_default_advert", v || "1")
                          }
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          value={vals.earning_mode ?? "simple"}
                          onValueChange={(v) =>
                            set("earning_mode", v || "simple")
                          }
                        >
                          <SelectTrigger className="bg-muted/50">
                            <SelectValue />
                    ...
                    <div className="space-y-6 pt-6 border-t border-border/30">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={vals.interstitial_ad_url ?? ""}
                          onChange={(e) =>
                            set("interstitial_ad_url", e.target.value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          value={vals.interstitial_banner_ad ?? ""}
                          onChange={(e) =>
                            set("interstitial_banner_ad", e.target.value)
                          }
                          placeholder="<script>...ad code...</script>"
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          value={vals.banner_728x90 ?? ""}
                          onChange={(e) => set("banner_728x90", e.target.value)}
                          placeholder="Leaderboard ad code"
                          className="bg-muted/50 font-mono text-xs resize-none"
                          rows={3}
                        />
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Textarea
                            value={vals.banner_468x60 ?? ""}
                            onChange={(e) =>
                              set("banner_468x60", e.target.value)
                            }
                            placeholder="Full banner code"
                            className="bg-muted/50 font-mono text-xs resize-none"
                            rows={3}
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <Textarea
                            value={vals.banner_336x280 ?? ""}
                            onChange={(e) =>
                              set("banner_336x280", e.target.value)
                            }
                            placeholder="Large rectangle code"
                            className="bg-muted/50 font-mono text-xs resize-none"
                            rows={3}
                          />
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-primary/20 bg-primary/5 mt-4">
                      <div>
                        <p className="text-sm font-bold text-primary">
                          Enable Publisher Earnings
                        </p>
                        <p className="text-xs text-muted-foreground mt-0.5">
                          Allow users to earn money when their links are
                          clicked.
                        </p>
                      </div>
                      <Switch
                        checked={vals.enable_publisher_earnings === "1"}
                        onCheckedChange={() =>
                          toggle("enable_publisher_earnings")
                        }
                      />
                    </div>
                    <div className="pt-6 flex justify-end">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative max-w-[200px]">
                        ...
                        <Input
                          type="number"
                          step="0.01"
                          value={vals.min_withdrawal ?? "5.00"}
                          onChange={(e) =>
                            set("min_withdrawal", e.target.value)
                          }
                          className="bg-muted/50 pl-7 font-semibold"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        type="text"
                        value={
                          vals.withdraw_processing_time ?? "2-3 business days"
                        }
                        onChange={(e) =>
                          set("withdraw_processing_time", e.target.value)
                        }
                        className="bg-muted/50 max-w-sm"
                      />
                      <p className="text-xs text-muted-foreground mt-1">
                        Displayed to users when requesting a payout.
                      </p>
                    </div>
                    <div className="pt-6 flex justify-end">
                      <SaveBtn
                        keys={["min_withdrawal", "withdraw_processing_time"]}
                        saving={saving}
                        onSave={save}
                      />
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-border/50 bg-card/40">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">
                          Force visitors to solve a CAPTCHA before link
                          redirection.
                        </p>
                      </div>
                      <Switch
                        checked={vals.enable_captcha === "yes"}
                        onCheckedChange={() =>
                          set(
                            "enable_captcha",
                            vals.enable_captcha === "yes" ? "no" : "yes"
                          )
                        }
                      />
                    </div>
                    ...
                    <div
                      className={cn(
                        "space-y-4 pt-4 border-t border-border/30 transition-opacity",
                        vals.enable_captcha !== "yes" &&
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          type="password"
                          value={vals.recaptcha_secret_key ?? ""}
                          onChange={(e) =>
                ...
                {activeTab === "advanced" && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        value={vals.custom_css ?? ""}
                        onChange={(e) => set("custom_css", e.target.value)}
                        className="bg-muted/50 font-mono text-xs resize-none min-h-[120px]"
                        placeholder="body { ... }"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Textarea
                        value={vals.custom_js_header ?? ""}
                        onChange={(e) =>
                          set("custom_js_header", e.target.value)
                        }
                        className="bg-muted/50 font-mono text-xs resize-none min-h-[120px]"
                    ...
                    <div className="pt-6 flex justify-end">
                      <SaveBtn
                        keys={["footer_text", "custom_css", "custom_js_header"]}
                        saving={saving}
                        onSave={save}
                      />
                    </div>
